...
//
//                    if (comm::RetCode::RET_OK != ret) {
//                        QLErr("paxos_group_id %d GetCurrent err %d", paxos_group_id, ret);
//
//                        continue;
//                    }
//
//                    // add expired lock key
//                    if (now > local_lock_info.expire_time()) {
//                        // TODO: use move?
...
//            if (comm::RetCode::RET_OK != ret) {
//                QLErr("paxos_group_id %d ProposeCleanLock err %d", paxos_group_id, ret);
//            }
//
//        }  // foreach group
//
...
#endif
static char gzrd_Lib_CPP_Version_ID[] __attribute__((used))="$HeadURL: http://scm-gy.tencent.com/gzrd/gzrd_mail_rep/phoenix_proj/trunk/phxqueue/src/lock/cleanthread.cpp $ $Id: cleanthread.cpp 2124396 2017-06-15 03:58:06Z walnuthe $ " GZRD_SVN_ATTR "__file__";
